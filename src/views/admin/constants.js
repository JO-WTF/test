...
export const TRANSPORT_MANAGER_STATUS_DELIVERY_CARDS = [
  { status_delivery: STATUS_DELIVERY_VALUES.PREPARE_VEHICLE, label: STATUS_DELIVERY_VALUES.PREPARE_VEHICLE },
  { status_delivery: STATUS_DELIVERY_VALUES.ON_THE_WAY, label: STATUS_DELIVERY_VALUES.ON_THE_WAY },
  { status_delivery: STATUS_DELIVERY_VALUES.ON_SITE, label: STATUS_DELIVERY_VALUES.ON_SITE },
  { status_delivery: STATUS_DELIVERY_VALUES.POD, label: STATUS_DELIVERY_VALUES.POD },
  { status_delivery: STATUS_DELIVERY_VALUES.WAITING_PIC_FEEDBACK, label: STATUS_DELIVERY_VALUES.WAITING_PIC_FEEDBACK },
  {
    status_delivery: STATUS_DELIVERY_VALUES.REPLAN_MOS_LSP_DELAY,
    label: STATUS_DELIVERY_VALUES.REPLAN_MOS_LSP_DELAY,
  },
  { status_delivery: STATUS_DELIVERY_VALUES.REPLAN_MOS_PROJECT, label: STATUS_DELIVERY_VALUES.REPLAN_MOS_PROJECT },
  { status_delivery: STATUS_DELIVERY_VALUES.CANCEL_MOS, label: STATUS_DELIVERY_VALUES.CANCEL_MOS },
  { status_delivery: STATUS_DELIVERY_VALUES.CLOSE_BY_RN, label: STATUS_DELIVERY_VALUES.CLOSE_BY_RN },
