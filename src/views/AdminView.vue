            ...
            <div class="row-line">
              <div class="field">
                ...
                <select id="f-status">
                  ...
                  <option value="准备车辆" data-i18n="status.prepareVehicle">准备车辆</option>
                  <option value="开始运输" data-i18n="status.startTransport">开始运输</option>
                  <option value="重新排期(LSP)" data-i18n="status.rescheduleLsp">重新排期(LSP)</option>
                  <option value="项目重排(Project)" data-i18n="status.projectReschedule">项目重排(Project)</option>
                  <option value="取消MOS" data-i18n="status.cancelMos">取消MOS</option>
                  <option value="RN关闭" data-i18n="status.rnClosed">RN关闭</option>
                </select>
              </div>
